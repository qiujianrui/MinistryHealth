...
public class BaseViewHolder extends RecyclerView.ViewHolder {
    ...
    /**
     * @param viewId       viewId
     * @param isVisibility 是否显示 turn 显示 false不显示
     * @return 返回本身
     */
    public BaseViewHolder setVisibility(int viewId, boolean isVisibility) {
        View view = getView(viewId);
    ...
    /**
     * @param viewId     viewId
     * @param isSelector 是否选中 turn 选中 false不选中
     * @return 返回本身
     */
    public BaseViewHolder setSelected(int viewId, boolean isSelector) {
        View view = getView(viewId);
