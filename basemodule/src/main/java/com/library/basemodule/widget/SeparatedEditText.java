...
public class SeparatedEditText extends androidx.appcompat.widget.AppCompatEditText {
    ...
    public SeparatedEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        textSize = ta.getDimension(R.styleable.SeparatedEditText_textSize, 20);
        ...
        blockColor = ta.getColor(R.styleable.SeparatedEditText_blockColor, ContextCompat.getColor(getContext(), R.color.baseColor));
    ...
    private void init() {
        ...
        postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                if (imm == null) return;
                imm.showSoftInput(SeparatedEditText.this, 0);
            }
        },100);
