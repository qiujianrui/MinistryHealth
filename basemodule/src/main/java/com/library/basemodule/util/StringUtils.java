...
public final class StringUtils {
    ...
    // 是否是邀请码   // spoker####AAAB####
    public static boolean isLnvite(CharSequence text) {
        if (isEmpty(text)) {
            return false;
        }
        // spoker####AAAB####
        ...
        if (text.toString().startsWith("spoker####")) {
            return true;
        } else {
            return false;
        }
    ...
    public static boolean isStartsWith(CharSequence text, final String regexUrl) {

        if (isEmpty(text)) {
            return false;
        }
        return text.toString().startsWith(regexUrl);
    }
