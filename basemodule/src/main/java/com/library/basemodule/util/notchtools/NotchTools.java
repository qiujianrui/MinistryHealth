package com.library.basemodule.util.notchtools;

import android.app.Activity;
import android.os.Build;
import android.view.Window;

import com.library.basemodule.util.notchtools.core.INotchSupport;
import com.library.basemodule.util.notchtools.core.OnNotchCallBack;
import com.library.basemodule.util.notchtools.helper.DeviceBrandTools;
import com.library.basemodule.util.notchtools.helper.NotchStatusBarUtils;
import com.library.basemodule.util.notchtools.helper.ThreadUtils;
import com.library.basemodule.util.notchtools.phone.CommonScreen;
import com.library.basemodule.util.notchtools.phone.HuaWeiNotchScreen;
import com.library.basemodule.util.notchtools.phone.MiuiNotchScreen;
import com.library.basemodule.util.notchtools.phone.OppoNotchScreen;
import com.library.basemodule.util.notchtools.phone.PVersionNotchScreen;
import com.library.basemodule.util.notchtools.phone.VivoNotchScreen;
